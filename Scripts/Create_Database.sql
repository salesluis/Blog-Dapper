...
create table Post(
    ...
    CONSTRAINT [Fk_Category_Post] FOREIGN KEY ([CategoryId]) REFERENCES [Category]([Id]),
    CONSTRAINT [Fk_Author_Post] FOREIGN KEY ([AuthorId]) REFERENCES [User]([Id]),
    CONSTRAINT [Uk_Slug_Post] UNIQUE ([Slug])
)
